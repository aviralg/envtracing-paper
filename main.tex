...
s\underline{Y}s.frame, \underline{G}et, \underline{E}nvironment, and
\underline{A}ssign. Events happening to an environment passed to \eval are
enclosed by $[$ and $]$. The event sequence occurring on a call environment
after the call has ended is preceded by a $*$.
