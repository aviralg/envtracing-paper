...
Table~\ref{table:top_explicit_pack} shows the distribution of \newEnv calls for the top
14 packages.
...
The 55 packages have xxx functions that create explicit environments.
...
\begin{itemize}
\item[{\bf A, V}:] This set accounts for the majority of environments. It is
