...
\section{Environment Provenance}
...
%Formula. Only 597 of these environments were used for 855 formula construction. 389 of these environments were cre- 856 ated by testthat for code testing, implying that the code 857 being tested created a formula. The survival package cre- 858 ates explicit environments for use in formulas. We observe 859 22 environments created by survival::coxph and survival 860 ::model.frame.coxph to be used for formula construction, as 861 shown below. 862 863 864 865 866
%Eval. 162K (41%) of the explicit environments are used for 867
%dynamic code evaluation. These environments come from 868
%33 packages. 88.2% of these environments come from the 869
%vctrs package. Four packages, vctrs, testthat, magrittr, 870
%and rlang together contribute 98.2% of these environments.
