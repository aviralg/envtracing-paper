...
\paragraph{Discussion.} R provides a very rich API for interacting with
environment. This makes them very versatile objects. They primarily serve as
scopes, but can also be used as hash tables, and for sandboxing expression
evaluation. While R is lexically scoped, ad-hoc lookup strategies can be
implemented by accessing caller environments. The lexical scope of a function
can be changed, a technique used for designing custom object-oriented systems.
