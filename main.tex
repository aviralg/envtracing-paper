...
8.4K belong to selected packages. Since the executable scripts are extracted
from 100 packages, they don't provide good coverage for the transitively
...
These functions have 67,225 parameter positions. Figure~\ref{fig:paramdist}
shows the distribution of parameters of these functions. 3.0\% functions have 0
parameters, 22.4\% have 1, and 5.0\% have over 10. There are 4 functions with
over 50 parameters that come from 3 packages. Of those, \texttt{ggplot2::theme}
has the highest, 95 parameters.
