...
\noindent
\textbf{A, @, !:} This pattern shows up on the environments from the
...
functions to these environments to access the columns of the data frame, and sets
their environment to be the environment itself to ensure that lookup happens in
the correct scope. This also occurs in \code{R6} when a class environments is
set as the parent environment of a subclass environment.
